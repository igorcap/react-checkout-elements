...
const CardInput = (_ref) => {
  let {
    ...
    keyName = 'card'
      ...
      props = _objectWithoutProperties(_ref, ['pipe', 'type', 'keepCharPositions', 'mask', 'inline', 'label', 'placeholder', 'name', 'keyName']);

  return React.createElement(
    Field,
    _extends({}, props, { name: `${keyName}.${fieldName}` }),
    ({ field, form: { setFieldValue, touched, errors } }) => {
      ...
      return React.createElement(
        ...
        React.createElement(MaskedInput, _extends({
          ...
          type: type,
          render: (ref, maskedProps) => React.createElement(Input, _extends({
            ref: ref
          }, maskedProps, {
        ...
        !empty && React.createElement(Clear, { onClick: clear })
      );
    }
  );
};
...
const CardNumber = ({ placeholder = '4242 4242 4242 4242' }) => React.createElement(CardInput, {
  label: '\u041D\u043E\u043C\u0435\u0440 \u043A\u0430\u0440\u0442\u044B',
  placeholder: placeholder,
  name: 'number',
...
const CardExpiry = ({ placeholder = '04 / 22' }) => React.createElement(CardInput, {
  label: '\u0421\u0440\u043E\u043A \u0434\u0435\u0439\u0441\u0442\u0432\u0438\u044F',
  placeholder: placeholder,
  name: 'expiry',
...
const CardHolder = () => React.createElement(CardInput, { name: 'holder' });
...
const CardCVV = ({ placeholder = '123' }) => React.createElement(CardInput, {
  label: 'CVV \u043A\u043E\u0434',
  placeholder: placeholder,
  type: 'password',
  name: 'cvv',
...
const windowOpened = () => {
  return window && window.threedSecureWindow && window.threedSecureWindow.closed === false;
};
...
class ThreedSecure extends React.Component {
  ...
  open(title = '3ds авторизация', width = 460, height = 560) {
    ...
    const params = ['scrollbars=yes', 'menubar=no', 'dependent=yes', 'dialog=yes', 'minimizable=no', 'resizable=no', 'centerscreen=yes', 'copyhistory=no', 'chrome=yes', 'width=' + width, 'height=' + height, 'top=' + top, 'left=' + left].join();
      ...
      React.createElement(
        ...
        React.createElement(
          ...
          React.createElement(
            'p',
            null,
            '\u041D\u0430\u0436\u043C\u0438\u0442\u0435 \xAB\u041F\u0440\u043E\u0434\u043E\u043B\u0436\u0438\u0442\u044C\xBB, \u0435\u0441\u043B\u0438 \u043D\u0435 \u0432\u0438\u0434\u0438\u0442\u0435 \u043E\u043A\u043D\u043E \u0441\u043E \u0441\u0442\u0440\u0430\u043D\u0438\u0446\u0435\u0439 \u0432\u0430\u0448\u0435\u0433\u043E \u0431\u0430\u043D\u043A\u0430.'
          )
        ),
        React.createElement(
          Continue,
...
const Loader = () => React.createElement('div', null);
...
const CreditCard = ({
  ...
  threedSecureUrl,
  threedSecure = false }) => React.createElement(
  React.Fragment,
  null,
  React.createElement(
    Fieldset,
    ...
    React.createElement(
      ...
      React.createElement(CardExpiry, null),
      React.createElement(CardCVV, null)
    )
  ),
  threedSecure && React.createElement(ThreedSecure, {
    onComplete: onThreedSecureComplete,
    url: threedSecureUrl })
);

export { CreditCard as default, ThreedSecure, validate };